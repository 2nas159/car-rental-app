...
// Temporary placeholder while Stripe is disabled
import React from 'react';
const PaymentForm = ({ booking, onSuccess, onCancel }) => (
  <div className="p-6 text-center">
    <h2 className="text-lg font-bold mb-4">Payment is currently disabled.</h2>
    <button
    ...
    <button
      className="py-2 px-4 bg-gray-300 text-gray-700 rounded-lg ml-4"
      onClick={onCancel}
    >
      Cancel
    </button>
